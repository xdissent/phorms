 ...
 * @abstract
 */
class TextFieldTestCase extends FieldTestCase
{
    /**
    ...
    {
        $this->field_class = 'Phorms_Fields_TextField';
     ...
     *
     * Overridden because TextField doesn't currently provide
