 ...
 * @abstract
 */
class EmailFieldTestCase extends FieldTestCase
{
    /**
    ...
    {
        $this->field_class = 'Phorms_Fields_EmailField';
        $this->test_label = 'Test field';
        $this->test_help = 'Enter your test value.';
        $this->entities_help = 'Enter & win.';
        $this->valid_value = 'test@example.com';
        $this->invalid_value = 'Not an email.';
    }
}
?>